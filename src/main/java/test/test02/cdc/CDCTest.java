...
/**flink  CDC 测试      mysql增量   到kafka   topic:  cdc_test
 *
 */
public class CDCTest {
    public static void main(String[] args) {
        try {
            ...
            env.setStateBackend(new FsStateBackend("hdfs://127.0.0.1:9000/flinkCDC"));
            ...
            DebeziumSourceFunction<String> mysqlSource = MySQLSource.<String>builder()
                    ...
                    .username("root")
                    .password("123456")
                    .tableList("test.cdctest") //这里的表名称,书写格式:db.table  不然会报错
                    .databaseList("test")
